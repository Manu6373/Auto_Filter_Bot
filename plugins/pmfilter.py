        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    ...
                    "<blockquote>"
                    "ನೀವು ನಮ್ಮ 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖? ನಲ್ಲಿ ಮಾತ್ರ 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 ಮಾಡಬಹುದು. "
                    "ನಿಮಗೆ Direct Bot ನಲ್ಲಿ 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄? ಮಾಡಲು ಅನುಮತಿ ಇಲ್ಲ.  
ದಯವಿಟ್ಟು ಕೆಳಗಿನ 𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑯𝑬𝑹𝑬 ಬಟನ್ ಮೇಲೆ ಕ್ಲಿಕ್ ಮಾಡಿ ನಮ್ಮ 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖𝒑 ಅನ್ನು ಜ್ವಾಯಿನ್ ಮಾಡಿ ಮತ್ತು ಅಲ್ಲೇ ನಿಮ್ಮ ಇಷ್ಟದ 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 ಮಾಡಿ."
                    "</blockquote></b>"
