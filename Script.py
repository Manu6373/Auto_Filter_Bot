...
<blockquote>👇 ಕೆಳಗಡೆ ಇರುವ ಸರಿಯಾದ movie  spelling ಆಯ್ಕೆ ಮಾಡಿ.</blockquote>"""
...
<blockquote>😌 ಕ್ಷಮಿಸಿ ಈ ಮೂವಿ ನನ್ನ ᴅᴀᴛᴀʙᴀꜱᴇ ನಲ್ಲಿ ಲಭ್ಯವಿಲ್ಲ</blockquote>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/McMoviesKA">{file_name}</a></b>\n\n<b>⚜️ For More Movies Join Here : <a href="https://t.me/McMoviesKA">[ @McMoviesKA ]</a></b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/McMoviesKA'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @KanFlixOwnerBot
...
<blockquote>ನಿಮ್ಮ <b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss</b> ತೆಗೆದುಹಾಕಲಾಗಿದೆ.  
ನಮ್ಮ ಸೇವೆಯನ್ನು ಬಳಸಿದಕ್ಕಾಗಿ ಧನ್ಯವಾದಗಳು 🥳  
ನಮ್ಮ ಇತರ ಯೋಜನೆಗಳಿಗಾಗಿ…
 <b>/plan</b> ಕ್ಲಿಕ್ ಮಾಡಿ.</blockquote>
"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/KanFlixOwnerBot'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
